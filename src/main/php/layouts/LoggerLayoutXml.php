...
/**
 * The output of the LoggerXmlLayout consists of a series of fs_log4php:event elements. 
 * 
 ...
 *   instead of fs_log4php namespace. This can be usefull when using log viewers 
...
class LoggerLayoutXml extends LoggerLayout {
	...
	/**
	 * If set to true, log4j namespace will be used instead of the fs_log4php 
	 * namespace.
	 * @var boolean 
	 */
	...
	/**
	 * Formats a {@link LoggerLoggingEvent} in conformance with the fs_log4php.dtd.
	 *
