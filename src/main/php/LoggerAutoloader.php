...
if (function_exists('__autoload')) {
	trigger_error("log4php: It looks like your code is using an __autoload() function. fs_log4php uses spl_autoload_register() which will bypass your __autoload() function and may break autoloading.", E_USER_WARNING);
}
...
class LoggerAutoloader {
	...
	private static $classes = array(
		...
		'LoggerAppenderKinesis' => '/appenders/LoggerAppenderKinesis.php',
		'LoggerAppenderDynamoDB' => '/appenders/LoggerAppenderDynamoDB.php',
        ...
        'LoggerLayoutSimpleJSON' => '/layouts/LoggerLayoutSimpleJSON.php',
