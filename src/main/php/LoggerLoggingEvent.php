...
class LoggerLoggingEvent {
	...
	*/
	...
	/** 
	 * The application supplied message rendered through the fs_log4php
	 ...
	 * fs_log4php saves here the process id via {@link PHP_MANUAL#getmypid getmypid()} 
	 * @var mixed
	 */
	private $threadName;
	...
	*/
	...
	/**
	 * @var LoggerThrowableInformation fs_log4php internal representation of throwable
	 */
