...
class LoggerConfigurationAdapterINI implements LoggerConfigurationAdapter {
	...
	*/
	 ...
	 * <pre>
	 * fs_log4php.logger.<name> = [<level>], [<appender-ref>, <appender-ref>, ...] 
	 * </pre>
	 * 
	 ...
	 * Appender class:
	 * <pre>
	 * fs_log4php.appender.<name> = <class>
	 * </pre>
	 * 
	 * Appender parameter:
	 * <pre>
	 * fs_log4php.appender.<name>.<param> = <value>
	 * </pre>
	 * 
 	 * Appender threshold:
	 * <pre>
	 * fs_log4php.appender.<name>.threshold = <level>
	 * </pre>
	 * 
 	 * Appender layout:
	 * <pre>
	 * fs_log4php.appender.<name>.layout = <layoutClass>
	 * </pre>
	 * 
	 * Layout parameter:
	 * <pre>
	 * fs_log4php.appender.<name>.layout.<param> = <value>
	 * </pre> 
	 * 
	 * For example, a full appender config might look like:
	 * <pre>
	 * fs_log4php.appender.myAppender = LoggerAppenderConsole
	 * fs_log4php.appender.myAppender.threshold = info
	 * fs_log4php.appender.myAppender.target = stdout
	 * fs_log4php.appender.myAppender.layout = LoggerLayoutPattern
	 * fs_log4php.appender.myAppender.layout.conversionPattern = "%d %c: %m%n"
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * fs_log4php.renderer.<renderedClass> = <renderingClass> 
	 * </pre>
	 * 
	 * @param string $key fs_log4php.renderer.<renderedClass>
