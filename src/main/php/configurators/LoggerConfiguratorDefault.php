 ...
 * 
 * Configures fs_log4php based on a provided configuration file or array.
 * 
 * @package fs_log4php
...
class LoggerConfiguratorDefault implements LoggerConfigurator
{
	...
	/**
	 * Configures fs_log4php based on the given configuration. The input can 
	 ...
	 * parsed for whatever reason, a warning will be issued, and fs_log4php
	...
	/** 
	 * Returns the default fs_log4php configuration.
	 * @return array
	 */
	...
	private function configureAppender($name, $config) {
		...
		$class = $config['class'];
		if (empty($class)) {
		    // If you're here, you probably forgot to update main/php/LoggerAutoloader.php
