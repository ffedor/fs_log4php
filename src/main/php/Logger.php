...
/**
 * This is the central class in the fs_log4php package. All logging operations 
...
class Logger {
	...
	/** The logger hierarchy used by fs_log4php. */
	private static $hierarchy;
	
	/** Inidicates if fs_log4php has been initialized */
	...
	/**
	 * Returns true if the fs_log4php framework has been initialized.
	 * @return boolean 
	 */
